            ...
            Notifications.find({testID: u._id}).exec(function(err, n) {
                ...
                n.forEach(function(l){
                    Stock.findOne({_id: l.testID}).exec(function(err, b) {
                        ...
                        client.messages 
                        .create({ 
                        body: 'FindACovidTest.org Notification - ' + b.testType + ' is in stock at ' + b.store + '. More details here: ' + 'https://www.findacovidtest.org/#' + b._id + '.' + ' To continue to receive notifications click here: ' + 'https://notifications.findacovidtest.org/notification/create?id=' + b.id,  
